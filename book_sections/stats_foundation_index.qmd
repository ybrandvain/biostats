...
* Next, we must internalize key ideas of probability and stochasticity -- i.e. that what we see in this world is one of numerous potential outcomes. This is covered in **Chapter 12**.
* Putting these ideas together, we can add a measure of humility to our estimates by noting the uncertainty around them. **Chapter 13** introduces this concept, while **Chapter 14** introduces bootstrapping as a technique to think more clearly about and quantify this uncertainty.
* Finally, we aim to evaluate if two samples plausibly come from the same "population." **Chapter 15** lays out the foundational idea of Null Hypothesis Significance Testing (NHST), while **Chapter 16** introduces permutation as a method to both clarify NHST and perform such a test.