### • 2. Summarizing columns {.unnumbered}
...
We [previously used the mean function](getting_started.qmd##working-with-vectors) to find the mean of a vector. When we want to summarize a variable in a tibble we use the function inside of [`summarize()`](https://dplyr.tidyverse.org/reference/summarise.html).  
