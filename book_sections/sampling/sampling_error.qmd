...
3.  **Understand the to most common meaures of uncertainty:**   
    - The standard error.
...
The two most common summaries of uncertainty are the standard error, and the 95% confidence interval. 
...
- **The 95% confidence interval** describes the middle ninety-five percent of the sampling distribution. i.e. the upper and lower 2.5% quantiles. If we had a a sampling distribution in hand we could find this in R as `quantile(my_sampling_dist, probs = c(0.025, 0.975))`.  
