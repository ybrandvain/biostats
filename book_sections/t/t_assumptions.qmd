...
**Motivating scenario:** Statistical modelling allows us to test null hypotheses and quantify uncertainty. But results from these models are only as good as the data and the fit between data and assumptions of the analysis. Here we learn  how to check these assumptions. By mastering these concepts, you will become more than someone who can push a button in R, you will be a good biostatistician. 
