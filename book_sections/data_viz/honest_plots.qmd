...
:::exercises
**Rather than me telling you what's wrong here** I want you to figure out what's wrong and fix it. But you won't be on your own, this [**chatbot tutor**](https://chatgpt.com/g/g-68cff7684f108191ad749b5e7b2b7eba-help-fixing-plot) is here to help! [**Prompt available here**](https://docs.google.com/document/d/e/2PACX-1vQmZrPc3A_4llzC16NyhstnBFo7_Txvzvg0JlGSkZtIW30SUiuiBi_VOyREzW5qMv-hGMKycnUVHwky/pub) if you want to make your own gem.

`r hide("HINT")`
Not all days the same length.
`r unhide()`
