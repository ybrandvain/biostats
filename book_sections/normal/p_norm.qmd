...
- **Find our Z-statistic:** Z is the number of standard errors between our observation and the value proposed under the null hypothesis. We find it as $Z=\frac{\text{parameter estimate} - \text{null value of the parameter}}{SE_x}$.
