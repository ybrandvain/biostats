...
4.  Know that the standard error is the the standard deviation of the sampling distribution.     

    - The standard error of a sample from a normal distribution is $\sigma/\sqrt{n}$ where $n$ is the sample size.   
:::
