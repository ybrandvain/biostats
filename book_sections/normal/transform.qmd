...
Not all data can be made to be normal. If you are worried that even after transformation your data are too far from normal for standard linear models, don't despair! We can build modles that better meet the data, permute/bootstrap, or find a better test. 